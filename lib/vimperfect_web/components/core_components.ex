defmodule VimperfectWeb.CoreComponents do
  @moduledoc """
  ...
  def back(assigns) do
    ~H"""
    <div class="mt-16">
      <.link navigate={@navigate} class="link">
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(VimperfectWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(VimperfectWeb.Gettext, "errors", msg, opts)
    end
  end
