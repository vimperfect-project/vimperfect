defmodule Vimperfect.AccountsFixtures do
  @default_ssh_key "ssh-rsa AAAAB3NzaC1yc2EAAAADAQABAAAAgQDZpN5HUZOjsu6hKpSyd3O7L4a4WI+SW+w5gpbLrK1uCGn5e4W1g+xBQSKFcuz3HAVb1Dn3unQMY8fQq4NUGN9OI+45jMti/Jm0Wdsib6OfKGAAxjrG3khQ8BpqIGb/eY9vgW40FbEr80PCCcgHDlUbvMeH52Qs0ub/ZgAlisddew== alice@example"
  ...
  * email: "bob@example.com"
  ...
  def add_public_key_fixture(user, public_key \\ @default_ssh_key) do
    {:ok, user} =
